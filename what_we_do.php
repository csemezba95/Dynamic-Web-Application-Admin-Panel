<?php
	...
	//get data
	$get_data_sql = "SELECT * FROM what_we_dos";
	...
	if (isset($_POST['delete_id'])) {
		...
		$get_single_data_sql = "SELECT * FROM what_we_dos WHERE id = '$delete_id'";
		...
		$delete_sql = "DELETE FROM what_we_dos WHERE id = '$delete_id'";
    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
			...
			<div class="table-responsive">     
			  <a href="what_we_do_add.php" class="btn btn-primary btn-sm" style="width: 250px;margin-bottom: 20px;"><i class="fa fa-plus"></i> Add New What We Do</a>	
			  ...
			  <table class="table table-bordered table-striped table-hover table-condensed">
				...
				<?php 	foreach ($get_data_sql_result as $get_data_sql_result_row) {?>
				  <tr>
					...
					<td>
						 <img src="<?php echo $backUpload.$get_data_sql_result_row["img"];?>" alt="<?php echo $get_data_sql_result_row["title_en"];?>" width="200px;">
					</td>
					<td>
						<a href="what_we_do_edit.php?id=<?php echo $get_data_sql_result_row['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-edit"></i> Edit</a>
