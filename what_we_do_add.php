<?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$insert_sql = "INSERT INTO what_we_dos (title_en, title_bn, text_en, text_bn, img) 
			VALUES ('$title_en', '$title_bn', '$text_en', '$text_bn', '$newFileName')";
...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
			...
			<?php } ?>
			<form action="what_we_do_add.php" method="post" enctype="multipart/form-data" style="border: 1px solid #ddd;padding: 20px;border-radius: 4px;background: aliceblue">
