...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insert_sql = "INSERT INTO our_projects_infos (title_en, title_bn, project_detail_en, project_detail_bn) 
            VALUES ('$title_en', '$title_bn', '$project_detail_en', '$project_detail_bn')";
        ...
        if ($conn->query($insert_sql) === TRUE) {
            ...
            if (!empty($_FILES['img']['tmp_name'])) {
                ...
                foreach ($uploadedFiles['name'] as $key => $value) {
                    ...
                    $insert_file_sql = "INSERT INTO our_projects_infos_file (project_id, img) 
...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <?php } ?>
            <form action="project_add.php" method="post" enctype="multipart/form-data" style="border: 1px solid #ddd;padding: 20px;border-radius: 4px;background: aliceblue">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <label for="project_detail_en">Text (English):</label>
                        <textarea class="form-control" id="project_detail_en" name="project_detail_en" required></textarea><br>
                        
                        <label for="project_detail_bn">Text (Bangla):</label>
                        <textarea class="form-control" id="project_detail_bn" name="project_detail_bn" required></textarea><br>
                    </div>
                    <div class="col-md-12">
