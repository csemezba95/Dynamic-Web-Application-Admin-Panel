<?php
	...
	//get data
	$get_data_sql = "SELECT * FROM our_projects_infos";
	...
	if (isset($_POST['delete_id'])) {
		...
		$get_all_data_sql = "SELECT * FROM our_projects_infos_file WHERE project_id = '$delete_id'";
		...
		$delete_child_sql = "DELETE FROM our_projects_infos_file WHERE project_id = '$delete_id'";
	
		if ($conn->query($delete_child_sql) === TRUE) {
			$delete_sql = "DELETE FROM our_projects_infos WHERE id = '$delete_id'";
    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
			...
			<div class="table-responsive">     
			  <a href="project_add.php" class="btn btn-primary btn-sm" style="width: 250px;margin-bottom: 20px;"><i class="fa fa-plus"></i> Add New Project</a>	
			  ...
			  <table class="table table-bordered table-striped table-hover table-condensed">
				...
				<?php foreach ($get_data_sql_result as $get_data_sql_result_row) { ?>
				  <tr>
					...
					<td>
						<a href="project_edit.php?id=<?php echo $get_data_sql_result_row['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-edit"></i> Edit</a>
