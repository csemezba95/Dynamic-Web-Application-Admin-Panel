<?php
	...
	//get data
	$get_data_sql = "SELECT * FROM organization_details_infos";
	$get_data_sql_result = $conn->query($get_data_sql);
	
	//delete data
	if (isset($_POST['delete_id'])) {
		$delete_id = $_POST['delete_id'];
		$delete_sql = "DELETE FROM organization_details_infos WHERE id = '$delete_id'";
    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
			...
			<div class="table-responsive">     
			  <a href="organizational_details_add.php" class="btn btn-primary btn-sm" style="width: 250px;margin-bottom: 20px;"><i class="fa fa-plus"></i> Add New Information</a>	
			  ...
			  <table class="table table-bordered table-striped table-hover table-condensed">
				...
				<?php 	foreach ($get_data_sql_result as $get_data_sql_result_row) {?>
				  <tr>
					...
					<td>
						<a href="organizational_details_edit.php?id=<?php echo $get_data_sql_result_row['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-edit"></i> Edit</a>
